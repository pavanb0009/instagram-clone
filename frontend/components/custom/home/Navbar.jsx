...
import { navbarSvgs } from '@/lib/helpers'
...
const Navbar = () => {
    ...
    return (
        <div className="fixed top-0 left-0 border border-input w-full p-3 flex justify-between md:hidden">
            <div>
            ...
            <div className='flex items-center gap-5'>
                {navbarSvgs.map((item, index) => (
                    <Link href={item.href}>
                        <div key={index} className='' onClick={() => setActiveItem(item.href)}>
                            {activeItem === item.href ? item.activeIcon : item.inactiveIcon}
                        </div>
                    </Link>
                ))}
            </div>
